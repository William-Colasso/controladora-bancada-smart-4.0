 ...
 * PLC vive no bean {@link MontagemCLP} (model/clp), não em campos do service. Sem banco. Sem polling.
 */
@Service
...
public class MontagemClpService implements EstacaoClpHandshake {
    ...
    /** Lê o bloco DB da estação MONTAGEM no IP informado, decodifica e processa, sob demanda. */
    @Override
    ...
    /** Só leitura CLP: decodifica o bloco lido no bean {@link MontagemCLP}. Não escreve no CLP nem no banco. */
